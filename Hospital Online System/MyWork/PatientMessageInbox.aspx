<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PatientMessageInbox.aspx.cs" Inherits="MyWork_MessagesMain" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/MyWork/PatientSend.aspx">Create New Message</asp:HyperLink>
